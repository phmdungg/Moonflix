        ...
        <SideBar>
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='w-full grid md:grid-cols-2 gap-6'>
                    <Input label='Movie Title' placeholder='Queen Of Tears' type='text' bg={true} />
                    <Input label='Hours' placeholder='2hr' type='text' bg={true} />
                </div>
                <div className='w-full grid md:grid-cols-2 gap-6'>
                    <Input label='Language Used' placeholder='English' type='text' bg={true} />
                    <Input label='Year of Release' placeholder='2022' type='text' bg={true} />
                </div>
                {/* images */}
                <div className='w-full grid md:grid-cols-2 gap-6'>
                    {/* img without title */}
                    ...
                    <div className='grid 2xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-4 grid-cols2 gap-4'>
                        {
                            UsersData.map((user, i) => (
                                ...
                                <img src={`/images/${user.image ? user.image : 'user.png'}`}
                                alt={user.fullName}
